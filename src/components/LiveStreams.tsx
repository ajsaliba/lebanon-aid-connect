      ...
      >
        <div className="flex items-center gap-2">
          ...
          {shouldPause && expanded && !manualPause && (
            <span className="text-[9px] text-muted-foreground">(auto-paused)</span>
          )}
        </div>
      ...
      {expanded && (
        <div className="p-2 space-y-2">
          ...
          <div className="flex gap-1 flex-wrap items-center">
            ...
            >
              <Pause className="h-3 w-3" /> {manualPause ? 'Resume' : 'Pause'}
            </Button>
          </div>
              ...
              {isPaused ? (
                <>
                  ...
                  <p className="text-xs font-medium text-muted-foreground">
                    {manualPause ? 'Manually paused' : 'Auto-paused (idle)'}
                  </p>
                  <p className="text-[10px] text-muted-foreground">Click Resume or move your mouse to continue</p>
                </>
              ) : (
                <>
